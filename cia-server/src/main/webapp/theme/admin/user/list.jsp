    ...
    $.ajax({ 
        ...
        success : function(data){           
            ...
            $(data.list).each(function(i,d){
                ...
                c += '<a class="hipro_cursor" href="./view?idx='+d.idx+'" style="position: relative;">';
                ...
                c += '<td>';
                	...
                	try{
                		if(!d.authList.includes("ROLE_ALBA") && d.albaRegistFlag>0) {
                    		c += " <span style='color:red;'>선수심사</span> ";
                    	}
                    	else{
                    		 
                    	}
                	}catch(err) {
                		console.log(d.authList);
                	}
